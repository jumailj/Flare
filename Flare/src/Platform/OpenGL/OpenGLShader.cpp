...
namespace Flare{
		...
		static GLenum ShaderTypeFromString(const std::string& type)
		{
			...
			LOG_ERROR("unknow shader!, ShaderTypeFromString()");
			return 0;
		}
		...
		static shaderc_shader_kind GLShaderStageToShaderC(GLenum stage)
		{
			...
			LOG_ERROR("unknow stage, in GLShaderStageToShaderC()");
		...
		static const char* GLShaderStageToString(GLenum stage)
		{
			...
			LOG_ERROR("unknow stage, in GLShaderStageToString()");
			return nullptr;
		}
		...
		static const char* GetCacheDirectory()
		{
			...
			return "Resource/cache/shader/opengl";
		}
		...
		static const char* GLShaderStageCachedOpenGLFileExtension(uint32_t stage)
		{
			...
			LOG_ERROR("unknow stage, GLShaderStageCachedOpenGLFileExtension()");
		...
		static const char* GLShaderStageCachedVulkanFileExtension(uint32_t stage)
		{
			...
			LOG_ERROR("unknown stage, GLShaderStageCachedVulkanFileExtension()");
			return "";
		}
	...
	std::unordered_map<GLenum, std::string> OpenGLShader::PreProcess(const std::string& source)
	{
		...
		while (pos != std::string::npos)
		{
			...
			if(!Utils::ShaderTypeFromString(type)){
				LOG_ERROR("Invalid shader type specified");
			}
